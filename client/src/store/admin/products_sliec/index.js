...
// export const addNewProducts=createAsyncThunk("products/addproducts", async (formdata)=>{

//     const response=await axios.post("http://localhost:5000/api/admin/products/addproducts",formdata,{
//         Headers:{
...
//     const response=await axios.get("http://localhost:5000/api/admin/products/fetchallproducts",)
...
// export const editAProducts=createAsyncThunk("products/editproducts", async (id,formdata)=>{

//     const response=await axios.put(`http://localhost:5000/api/admin/products/editproduct/${id}`,formdata,{
//         Headers:{
//             "Content-Type":"application/json"
//         }   
//     })
...
//     const response=await axios.delete(`http://localhost:5000/api/admin/products/deleteproduct/${id}`)
//      console.log("deleteProducts:",response.data)
//     return response.data;
   
// })


// const AdminProductSlicee=createSlice({
...
//             console.log("action.payload on featchine slice:", action.payload)
